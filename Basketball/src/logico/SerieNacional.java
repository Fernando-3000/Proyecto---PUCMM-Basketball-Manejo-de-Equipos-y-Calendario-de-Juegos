...
public class SerieNacional implements Serializable {
    ...
    // M�todos de modificaci�n (para uso en memoria, aunque ahora se usa DatabaseManager)
    ...
    // Generar juegos (solo en memoria, aunque ahora se usa en combinaci�n con DatabaseManager)
