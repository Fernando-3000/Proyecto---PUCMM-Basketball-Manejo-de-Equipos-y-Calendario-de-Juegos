...
public class PsimulacionJuego extends JDialog {
	...
	public PsimulacionJuego() {
		...
		// A�adir MouseListener al panel principal para detectar clics fuera de las tablas
		...
		// A�adir MouseListener al panel del equipo 1 para detectar clics fuera de la tabla
		...
		// A�adir MouseListener al panel del equipo 2 para detectar clics fuera de la tabla
		...
		// A�adir MouseListener al panel de botones para detectar clics
		panel_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				// Solo deseleccionar si el clic fue en el panel pero no en un bot�n
	...
	// M�todo para deseleccionar el jugador
	...
	// M�todo para habilitar o deshabilitar botones de acci�n
